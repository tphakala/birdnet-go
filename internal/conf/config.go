...
type DashboardElement struct {
	...
	Type    string                `json:"type" yaml:"type"`                           // "banner", "daily-summary", "new-species-highlights", "currently-hearing", "recent-hearing", "detections-grid", "live-spectrogram", "video-embed"
