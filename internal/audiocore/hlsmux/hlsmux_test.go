...
func TestNewValidatesConfig(t *testing.T) {
	...
	tests := []struct {
		...
		{"sample rate below the floor", func(c *Config) { c.SampleRate = 7999 }, "below the minimum"},
		{"sample rate above the ceiling", func(c *Config) { c.SampleRate = 384001 }, "exceeds the maximum"},
