...
func createTrackerForConcurrentTest(t *testing.T, enableYearly, enableSeasonal bool) *NewSpeciesTracker {
	t.Helper()
...
func executeConcurrentOperations(tracker *NewSpeciesTracker, species []string, 
...
func runGoroutineOperations(tracker *NewSpeciesTracker, species []string, 
...
func performRandomOperation(tracker *NewSpeciesTracker, species []string, 
