...
<div class="bg-[var(--surface-100)] border border-[var(--border-100)] rounded-xl p-4 shadow-sm">
  <div class="flex items-center justify-between mb-3">
    ...
    <span class="text-xs font-mono tabular-nums text-muted">
    ...
    <table class="w-full text-sm">
      <thead>
        <tr class="border-b border-[var(--border-100)]">
          ...
          {/each}
          <th scope="col" class="text-left py-2 px-3 text-xs font-medium text-muted">
          ...
          >
            ...
            <td class="py-2 px-3">
              <div class="flex items-center gap-2">
                ...
                <span class="font-mono tabular-nums text-[10px] text-muted">{pct.toFixed(1)}%</span>
              </div>
            </td>
          </tr>
        {/each}
