<script lang="ts">
  ...
  // Default empty state icon if none provided
  const defaultIcon = `<svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 text-base-content/20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
