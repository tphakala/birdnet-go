                    ...
                    {#if notification.type === 'error'}
                      <div class="w-5 h-5">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" d={alertIcons.error} />
                        </svg>
                      </div>
                    {:else if notification.type === 'warning'}
                      <div class="w-5 h-5">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" d={alertIcons.warning} />
                        </svg>
                      </div>
                    {:else if notification.type === 'info'}
                      <div class="w-5 h-5">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" d={alertIcons.info} />
                        </svg>
                      </div>
