...
describe('Color Contrast Tests', () => {
  ...
  describe('Light Theme Contrast', () => {
    ...
    it('should test low opacity text combinations', () => {
      ...
      console.log(`70% opacity: ${ratio70.toFixed(2)} (${ratio70 >= WCAG_AA_NORMAL ? 'PASS' : 'FAIL'})`);
      console.log(`60% opacity: ${ratio60.toFixed(2)} (${ratio60 >= WCAG_AA_NORMAL ? 'PASS' : 'FAIL'})`);
      console.log(`50% opacity: ${ratio50.toFixed(2)} (${ratio50 >= WCAG_AA_NORMAL ? 'PASS' : 'FAIL'})`);
