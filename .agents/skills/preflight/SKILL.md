...
- [ ] Tagged or OS-specific Go files changed: linted with those build tags (task lint BASE_BUILD_TAGS=<tags>), OS-specific files called out in the PR, and the cross-platform, Windows and macOS CI jobs green (see the root AGENTS.md)
