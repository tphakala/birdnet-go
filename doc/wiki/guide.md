...
- **FFmpeg**: Required for RTSP stream capture, audio export to MP3, AAC, and Opus (WAV and FLAC are encoded natively and do not need FFmpeg), and for the HLS live stream feature in the web interface
